...
public class ConsultationRequest {
    ...
    // Pas besoin de doctorId ou patientId ici, ils seront souvent passés en paramètres d'URL pour la création.
    // Pour la mise à jour, ces associations ne sont généralement pas modifiées via ce DTO.
}