...
@RequestMapping("/api/departments") // Toutes les routes de ce contrôleur commenceront par /api/departments
...
// --- Créer un nouveau département ---
    ...
    @PreAuthorize("hasRole('ADMIN')") // Seul un ADMIN peut créer un département
...
// --- Récupérer un département par ID ---
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'RECEPTIONNISTE', 'MEDECIN', 'INFIRMIER')") // Ces rôles peuvent consulter
...
// --- Mettre à jour un département existant ---
    ...
    @PreAuthorize("hasRole('ADMIN')") // Seul un ADMIN peut mettre à jour un département
...
// --- Supprimer un département ---
    ...
    @PreAuthorize("hasRole('ADMIN')") // Seul un ADMIN peut supprimer un département
