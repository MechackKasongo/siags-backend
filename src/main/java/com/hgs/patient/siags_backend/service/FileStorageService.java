...
public class FileStorageService {
    ...
    /**
     * Stocke un fichier et ses métadonnées.
     *
     * @param file        Le fichier à stocker.
     * @param patientId   L'ID du patient auquel associer le fichier.
     * @param description Une description optionnelle pour le fichier.
     * @return L'objet Attachment enregistré avec les métadonnées du fichier.
     */
    ...
    /**
     * Supprime un fichier et ses métadonnées de la base de données.
     *
    ...
    /**
     * Récupère toutes les pièces jointes pour un patient donné.
     *
     * @param patientId L'ID du patient.
     * @return Une liste d'objets Attachment.
     */
