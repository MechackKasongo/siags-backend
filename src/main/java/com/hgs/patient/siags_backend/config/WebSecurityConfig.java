...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Liste explicite des origines autorisées pour permettre les crédentiels
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                // AJOUT : Ajoutez cette ligne pour les endpoints de l'administrateur
                ...
                .cors(Customizer.withDefaults()); // Utilise la configuration CORS définie ci-dessus
